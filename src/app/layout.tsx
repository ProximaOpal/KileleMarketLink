...
export const metadata: Metadata = {
  ...
  description:
    "Visualize, orchestrate, and manage AI agents with real-time tools. Frosted color system, agentic layout, and the Terra live Earth map as its own scroll page.",
};
