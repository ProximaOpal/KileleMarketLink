...
export function Integrations() {
  return (
    <section id="integrations" className="border-t border-[#163a28]/10 px-6 py-32 md:px-12 lg:px-20">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="flex flex-col overflow-hidden rounded-2xl border border-[#163a28]/12 md:relative md:block">
          <div className="relative h-[280px] w-full shrink-0 md:h-[480px]">
            ...
            />
            <div className="absolute inset-0 bg-[#163a28]/25" />
          </div>
          <div className="flex flex-col gap-3 p-4 md:absolute md:bottom-4 md:right-4 md:w-72 md:p-0">
            <div
              ...
              style={{ backdropFilter: "blur(24px)", background: "rgba(22,58,40,0.72)" }}
            >
              ...
              <div className="rounded-lg border border-white/15 bg-[#081c15]/50 p-3 font-mono text-[11px] leading-relaxed text-white/80">
                ...
                <br />
                {"  "}
                <span className="text-[#c6e86a]">crop</span>: <span className="text-emerald-200">&apos;kale&apos;</span>,
                <br />
                {"  "}
                <span className="text-[#c6e86a]">kg</span>: <span className="text-white/50">420</span>
                {`,`}
                <br />
                {"  "}
                <span className="text-[#c6e86a]">gate</span>: <span className="text-emerald-200">&apos;Kiambu&apos;</span>
                <br />
                {`})`}
              </div>
            </div>
            ...
            >
              <div className="mb-2 flex items-center gap-2">
                <div className="h-2 w-2 animate-pulse rounded-full bg-[#c6e86a]" />
