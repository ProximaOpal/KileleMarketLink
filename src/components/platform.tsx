        ...
        <div className="grid grid-cols-12 gap-3">
          <GlassCard className="relative col-span-12 flex min-h-[200px] flex-col justify-between overflow-hidden p-8">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, transparent 35%, rgba(244,248,241,0.35) 50%, rgba(244,248,241,0.78) 65%, rgba(244,248,241,0.94) 80%, rgb(244,248,241) 100%)",
              }}
            />
            <div className="relative z-10">
              <div
                className="mb-6 flex h-10 w-10 items-center justify-center rounded-xl border border-[#163a28]/15 bg-white/70"
                style={{ backdropFilter: "blur(8px)" }}
              >
                <Target className="h-[18px] w-[18px]" strokeWidth={1.5} />
              </div>
              <h3 className="mb-3 text-xl font-light text-[#14261a]">Farm-gate batch tracker</h3>
              <p className="max-w-sm text-sm leading-relaxed text-[#14261a]/55">
          ...
          <GlassCard className="col-span-12 min-h-[200px] p-8 md:col-span-4">
            <div className="mb-5 flex h-10 w-10 items-center justify-center rounded-xl border border-[#163a28]/15">
