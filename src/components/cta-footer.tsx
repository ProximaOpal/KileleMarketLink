    ...
    <>
      <section className="relative overflow-hidden border-t border-[#0a0a0a]/10 px-6 py-32 md:px-12 lg:px-20">
        ...
        <div className="relative z-10 mx-auto max-w-2xl text-center">
          ...
          <p className="mb-10 text-sm leading-relaxed text-[#0a0a0a]/55">
            Join farms, factories, and city hubs dispatching foodstuff on decay clocks — Tatu, Konza, Nairobi, and the northern corridor.
          </p>
          {joined ? (
            <p className="text-sm tracking-wide text-[#0a0a0a]">You&apos;re on the list. We&apos;ll be in touch.</p>
          ) : (
      ...
      <footer className="border-t border-[#0a0a0a]/10 bg-white/70 px-6 py-10 md:px-12 lg:px-20">
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-8 md:flex-row md:items-center">
          <span className="font-pixel text-xs tracking-[0.25em] text-[#0a0a0a]/60">AGENTIC</span>
          ...
          <div className="flex items-center gap-6">
            {["Privacy", "Terms", "Docs", "GitHub"].map((item) => (
              <a key={item} href="#" className="text-xs tracking-widest text-[#0a0a0a]/30 transition-colors hover:text-[#0a0a0a]/70">
                {item}
              </a>
            ))}
          </div>
        </div>
        <div className="mx-auto mt-8 max-w-6xl border-t border-[#0a0a0a]/10 pt-6">
          <span className="text-xs text-[#0a0a0a]/30">© 2026 Agentic. Farm to city. All rights reserved.</span>
        </div>
      </footer>
    </>
  );
